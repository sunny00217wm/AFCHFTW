 ...
 * ===========
 * from https://github.com/Xi-Plus/twinkle/blob/8473c0095e7b14ad9aba51b7e707f2fc8d37168e/morebits.js
 * ===========
 * 自 [[../morebits.js|morebits.js]] 改編 
 * 避免改編汙染到其他東西（Ex.[[WP:TW]]）
 */
...
function wgULS (hans, hant, cn, tw, hk, sg, zh, mo, my) {
	...
	return ret[mw.config.get('wgUserLanguage')] || zh || hans || hant || cn || tw || hk || sg || mo || my; // 保證每一語言有值
};
...
}(AFCH.Morebits, window, document, jQuery)); // End wrap with anonymous function
...
if (typeof arguments === 'undefined') {  // typeof is here for a reason...
	...
	window.AFCH.SimpleWindow = AFCH.Morebits.simpleWindow;
	window.AFCH.QuickForm = AFCH.Morebits.quickForm;
	window.AFCH.Wikipedia = AFCH.Morebits.wiki;
	window.AFCH.Status = AFCH.Morebits.status;
}

// </nowiki>

window.AFCH.Morebits = AFCH.Morebits
// </nowiki>
